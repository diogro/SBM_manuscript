...
1. SI data 1 -- Data related to the simulations in figure 2

1. SI Figure 1 -- Exploration of the effect of FDR choice in the SBM clustering

1. SI Figure 2 -- WGCNA clustering using FDR trimming

2. SI table 1 -- Gene clustering using SBM and WGCNA

3. SI table 2 -- GO enrichment for all methods and tissues.

4. SI table 3 -- Summary statistics for all SBM blocks.
